...
* [`src/mpnote/styles.cljs`](src/mpnote/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/mpnote/`](src/mpnote/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/mpnote/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `mpnote` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/mpnote/config.cljs) defaults to `true` in
...
```clj
(ns mpnote.example
  (:require [mpnote.config :as config])
